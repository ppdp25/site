...
may be submitted (please contact the PC chair in case of questions). Research
papers will be judged on originality, significance, correctness, clarity, and
readability.
...
versions or any material beyond the respective page limit. Material beyond the
page limit will not be included in the final published version.
...
Template](https://www.acm.org/publications/proceedings-template), 
 at the time of writing being 2.12. You must use the
